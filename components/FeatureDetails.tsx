...
const FeatureDetails = () => {
  return (
    <section className="h-[500px] lg:grid grid-cols-2">
      <div className="bg-gray-100 text-gray-600 flex flex-col justify-center p-5 sm:p-10 md:p-20 lg:p-10">
        ...
        <div className="grid grid-cols-2 gap-10 mt-10">
          <div className="flex flex-row gap-5 items-center">
            <BsCheckLg className="size-16 text-primary bg-white " />
          ...
          <div className="flex flex-row gap-5 items-center">
            <LuDraftingCompass className="size-16 text-primary bg-white " />
            <div className="flex flex-col justify-center">
          ...
          <div className="flex flex-row gap-5 items-center">
            <BiSupport className="size-16 text-primary bg-white " />
            <div className="flex flex-col justify-center">
          ...
          <div className="flex flex-row gap-5 items-center">
            <FaUserCheck className="size-16 text-primary bg-white " />
            <div className="flex flex-col justify-center">
